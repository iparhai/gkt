...
parser.add_argument('--load-dir', type=str, default='logs/sample/expGKT-Transition', help='Where to load the trained model if finetunning. ' + 'Leave empty to train from scratch')
